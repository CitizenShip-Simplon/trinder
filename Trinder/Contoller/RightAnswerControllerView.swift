...
class RightAnswerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let phrase = ["6 briques de lait -> 1 rouleau de papier toilette", "9 bouteilles en plastique transparent -> 1 tee-shirt", "8 boîtes de conserves -> casserole", "250 canettes -> 1 cadre de vélo", "1OOO Kg de verre -> 2 138 bouteilles de 75 cl"]
        
        labelRandom.text = phrase[Int.random(in: 0...4)]
    }
}
