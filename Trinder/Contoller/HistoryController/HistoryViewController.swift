...
class HistoryViewController: UIViewController {
    ...
    var itemsInSections: Array<Array<UIImage>> = [[#imageLiteral(resourceName: "seaGlasses"), #imageLiteral(resourceName: "banaba"), #imageLiteral(resourceName: "ananas")], [#imageLiteral(resourceName: "meet"), #imageLiteral(resourceName: "canOfCoke"), #imageLiteral(resourceName: "paper"), #imageLiteral(resourceName: "bicycle")], [#imageLiteral(resourceName: "wineGlass"), #imageLiteral(resourceName: "bottleOfWine"), #imageLiteral(resourceName: "shotGlasses")], [#imageLiteral(resourceName: "painting"), #imageLiteral(resourceName: "cakeBox"), #imageLiteral(resourceName: "mirror")]]
