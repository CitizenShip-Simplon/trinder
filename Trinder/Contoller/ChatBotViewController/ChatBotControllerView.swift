...
class ChatBotViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    let names = ["Choisissez","Mobilier", "Alimentaire", "Emballage", "Verre", "Non triable", "Medical", "Textile", "High-tech",  "Electromenager"]
    
    let imagePharmacie = UIImage(named: "logo-pharmacie")
    let doner = UIImage(named: "doner")
    let reparer = UIImage(named: "reparer")
    let textile = UIImage(named: "images")
    let dechetterie = UIImage(named: "dechetterie")
